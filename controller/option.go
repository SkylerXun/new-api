...
func UpdateOption(c *gin.Context) {
	...
	case "GroupRatioDisplayLabels":
		err = ratio_setting.CheckGroupRatioDisplayLabels(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
	...
	case "console_setting.guides":
		err = console_setting.ValidateConsoleSettings(option.Value.(string), "Guides")
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
