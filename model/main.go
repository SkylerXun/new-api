...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&UserMonthlyBillingProgress{},
		&UserMonthlyBillingSettlement{},
		&ActivityGrant{},
		&ActivityCampaign{},
		&ActivityCampaignRecipient{},
		&SystemTask{},
		&SystemTaskLock{},
		&CasbinRule{},
		&AuthzRole{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&UserMonthlyBillingProgress{}, "UserMonthlyBillingProgress"},
		{&UserMonthlyBillingSettlement{}, "UserMonthlyBillingSettlement"},
...
` + "`hupijiao_discount_rate`" + ` decimal(5,4) NOT NULL DEFAULT 1,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "hupijiao_discount_rate", DDL: "`hupijiao_discount_rate` decimal(5,4) NOT NULL DEFAULT 1"},
