...
func InitOptionMap() {
	...
	common.OptionMap["GroupRatioDisplayLabels"] = ratio_setting.GroupRatioDisplayLabels2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "GroupRatioDisplayLabels":
		err = ratio_setting.UpdateGroupRatioDisplayLabelsByJSONString(value)
