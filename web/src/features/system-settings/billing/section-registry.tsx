...
const getGroupDefaults = (settings: BillingSettings) => ({
  ...
  GroupRatioDisplayLabels: settings.GroupRatioDisplayLabels,
    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          OnlinePaymentProvider: settings.OnlinePaymentProvider,
          HupijiaoAPIAddress: settings.HupijiaoAPIAddress,
          HupijiaoBackupAPIAddress: settings.HupijiaoBackupAPIAddress,
          HupijiaoWechatAppID: settings.HupijiaoWechatAppID,
          HupijiaoWechatSecret: settings.HupijiaoWechatSecret,
          HupijiaoAlipayAppID: settings.HupijiaoAlipayAppID,
          HupijiaoAlipaySecret: settings.HupijiaoAlipaySecret,
          HupijiaoPackages: settings.HupijiaoPackages,
