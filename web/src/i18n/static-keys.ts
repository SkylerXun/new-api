...
export const STATIC_I18N_KEYS = [
  ...
  // Account-linking risk control
  'Account Risk Control',
  'Account link risk control',
  ...
  'Registered before',
  'Start preview scan',
  'Historical preview scan started',
  'A historical preview scan is already running',
  'Historical scan failed',
  'Pause scan',
  'Resume scan',
  'Historical scan pause requested',
  'Historical scan resumed',
  'Failed to pause historical scan',
  'Failed to resume historical scan',
  'Scan status',
  ...
  'Approve and enforce',
  'Reject',
  'Linked accounts enforced',
  'Risk review rejected',
  'Failed to resolve risk review',
  ...
  'Remove link and restore',
  'Account relationship removed and account restored',
  'Failed to restore account',
  'Enabled',
  'Disabled',
  'Linked accounts',
  'This is the main account. Linked subaccounts are shown below.',
  'This account is linked to the following main account.',
  'Main account',
  'Subaccount',
] as const
