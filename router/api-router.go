...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.GET("/hupijiao/notify", controller.HupijiaoNotify)
			userRoute.GET("/hupijiao/return", controller.HupijiaoReturn)
			userRoute.POST("/hupijiao/return", anonymousRequestBodyLimit, controller.HupijiaoReturn)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/activities/:key/claim", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.ClaimUserActivity)
				selfRoute.GET("/linked-accounts", controller.GetLinkedAccounts)
				...
				selfRoute.GET("/topup/status", controller.GetHupijiaoPaymentStatus)
				selfRoute.POST("/topup", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.TopUp)
				selfRoute.POST("/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.RequestEpay)
				selfRoute.POST("/amount", controller.RequestAmount)
				selfRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.RequestStripePay)
				selfRoute.POST("/stripe/amount", controller.RequestStripeAmount)
				selfRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.RequestCreemPay)
				selfRoute.POST("/waffo/amount", controller.RequestWaffoAmount)
				selfRoute.POST("/waffo/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.RequestWaffoPay)
				selfRoute.POST("/waffo-pancake/amount", controller.RequestWaffoPancakeAmount)
				selfRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.RequestWaffoPancakePay)
				selfRoute.POST("/aff_transfer", middleware.UserCriticalRateLimit("aff-transfer"), middleware.AccountLinkageGuard(), controller.TransferAffQuota)
				...
				selfRoute.POST("/checkin", middleware.TurnstileCheck(), middleware.AccountLinkageGuard(), controller.DoCheckin)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/risk/exemptions", controller.ListRiskExemptions)
				adminRoute.POST("/risk/exemptions", controller.AddRiskExemption)
				adminRoute.DELETE("/risk/exemptions/:id", controller.RemoveRiskExemption)
				adminRoute.POST("/risk/backfill", controller.BackfillRiskAccountLinks)
				adminRoute.GET("/risk/backfill/:run_id", controller.GetRiskAccountBackfill)
				...
				adminRoute.POST("/:id/inviter", controller.BindInviter)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/balance/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.SubscriptionRequestBalancePay)
			subscriptionRoute.POST("/epay/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.SubscriptionRequestEpay)
			subscriptionRoute.POST("/hupijiao/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.SubscriptionRequestHupijiao)
			subscriptionRoute.GET("/hupijiao/status", controller.GetSubscriptionHupijiaoPaymentStatus)
			subscriptionRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.SubscriptionRequestStripePay)
			subscriptionRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.SubscriptionRequestCreemPay)
			subscriptionRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), middleware.AccountLinkageGuard(), controller.SubscriptionRequestWaffoPancakePay)
		}
		...
		apiRouter.POST("/subscription/hupijiao/notify", anonymousRequestBodyLimit, controller.SubscriptionHupijiaoNotify)
		apiRouter.GET("/subscription/hupijiao/notify", controller.SubscriptionHupijiaoNotify)
		apiRouter.GET("/subscription/hupijiao/return", controller.SubscriptionHupijiaoReturn)
		apiRouter.POST("/subscription/hupijiao/return", anonymousRequestBodyLimit, controller.SubscriptionHupijiaoReturn)
